...
To get up and running with Gatsby, you'll need to have [Node.js](https://nodejs.org/) installed on your computer. _Note: Gatsby's minimum supported Node.js version is Node 12, but for this guide you will need Node.js version 18._
...
First let's install some dependencies. We'll need `@staticcms/core` and `gatsby-plugin-static-cms`. Run the following command in the terminal at the root of your site:
